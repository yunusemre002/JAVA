...
public class TestAutoParkFalse {
	...
	public void testSearchVehicle() {
		...
		SubscribedVehicle actual = autopark.searchVehicle("02 SV 02");
	...
	public void testAddVehicle() {
		...
		boolean actual = autopark.addVehicle(s1);
	...
	public void testIsParked() {
		...
		boolean actual = autopark.isParked("03 SV 03");
	...
	public void testVehicleEnters() {
		...
		boolean actual = autopark.vehicleEnters(o1.getPlate(), new Time(20, 25), o1.isSpecial());
	...
	public void testVehicleExits() {
		...
		boolean actual = autopark.vehicleExits(o3.getPlate(), new Time(18, 24));
